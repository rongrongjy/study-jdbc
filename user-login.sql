...
CREATE TABLE `admin` (
                        #Auto-increment 会在新记录插入表中时生成一个唯一的数字。--
                         ...
                         #主键
                             PRIMARY KEY (`id`)
                             #将数据库的引擎设置为InnoDB（mysql中两种数据库引擎 ：MyISAM 、InnoDB）
                             #AUTO_INCREMENT=1112：自动增长的起始值为1112
...
-- ----------------------------
BEGIN;
INSERT INTO `commonuser` VALUES (1, '董丽君', '123', '董丽君', '410392839293829392', '145393895831', 'mars');
...
#ALGORITHM=UNDEFINED：指定视图的处理算法；默认算法是UNDEFINED（未定义的）
